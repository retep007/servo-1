        ...
        def specData(m):
            ...
            if "selfHostedName" in m:
                ...
                if m.get("methodInfo", True):
                    ...
                    jitinfo = "0 as *const JSJitInfo"
                    accessor = 'Some(generic_%s)' % m.get("nativeName", m["name"])
...
class AttrDefiner(PropertyDefiner):
    ...
    def generateArray(self, array, name):
        ...
        def getter(attr):
            if self.static:
                accessor = 'generic_get_' + self.descriptor.internalNameFor(attr.identifier.name)
                jitinfo = "0 as *const JSJitInfo"
            else:
        ...
        def setter(attr):
            ...
            if self.static:
                accessor = 'generic_set_' + self.descriptor.internalNameFor(attr.identifier.name)
                jitinfo = "0 as *const JSJitInfo"
            else:
                if attr.hasLenientThis():
...
class CGDOMJSClass(CGThing):
    ...
    def define(self):
        ...
        if self.descriptor.isGlobal():
            ...
            args["enumerateHook"] = "None/*Some(enumerate_global)*/"
            args["flags"] = "JSCLASS_IS_GLOBAL | JSCLASS_DOM_GLOBAL"
            args["slots"] = "JSCLASS_GLOBAL_SLOT_COUNT + 1"
            args["resolveHook"] = "None/*Some(resolve_global)*/"
...
static CLASS_OPS: js::jsapi::JSClassOps = js::jsapi::JSClassOps {
    ...
    mayResolve: None,
    finalize: None, //Some(%(finalizeHook)s),
    call: None,
    hasInstance: None,
    construct: None,
    trace: None,//Some(%(traceHook)s),
};

unsafe fn SIZE_OF(ops: &mut MallocSizeOfOps, p: *const os::raw::c_void) -> usize {
    unimplemented!()
}
...
let traps = ProxyTraps {
    enter: None,
    getOwnPropertyDescriptor: None/*Some(getOwnPropertyDescriptor)*/,
    defineProperty: None/*Some(%(defineProperty)s)*/,
    ownPropertyKeys: None/*Some(own_property_keys)*/,
    delete_: None/*Some(%(delete)s)*/,
    enumerate: None,
    ...
    hasOwn: None/*Some(hasOwn)*/,
    getOwnEnumerablePropertyKeys: None/*Some(%(getOwnEnumerablePropertyKeys)s)*/,
    nativeCall: None,
    hasInstance: None,
    objectClassIs: None,
    className: None/*Some(className)*/,
    fun_toString: None,
    boxedValue_unbox: None,
    defaultValue: None,
    trace: None/*Some(%(trace)s)*/,
    finalize: None/*Some(%(finalize)s)*/,
    objectMoved: None,
    isCallable: None,
    isConstructor: None,
};
...
class CGInitTypeHoldedMethod(CGAbstractMethod):
    ...
    def definition_body(self):
        properties = PropertyArrays(self.descriptor)
        define = ""
...
class CGStaticMethod(CGAbstractStaticBindingMethod):
    ...
    def define(self):
        res = super(CGStaticMethod, self).define()
        res += '''
static mut %(name)s_ptr: u64 = 0;

unsafe extern fn generic_%(name)s(cx: *mut JSContext, argc: libc::c_uint, vp: *mut JSVal) -> bool {
    mem::transmute::<_, fn(*mut JSContext, libc::c_uint, *mut JSVal) -> bool>(%(name)s_ptr)(cx, argc, vp)
}
        ''' % {'name':self.name}
        return res
...
class CGStaticGetter(CGAbstractStaticBindingMethod):
    ...
    def define(self):
        res = super(CGStaticGetter, self).define()
        res += '''
static mut %(name)s_ptr: u64 = 0;
...
class CGStaticSetter(CGAbstractStaticBindingMethod):
    ...
    def define(self):
        res = super(CGStaticSetter, self).define()
        res += '''
static mut %(name)s_ptr: u64 = 0;
